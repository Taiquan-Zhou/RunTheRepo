...
def _serialize(document: _EvidenceDocument) -> bytes:
    # Six commands with two 32,000-byte views leave at least 131,072 bytes for JSON metadata.
    if _MAX_ARTIFACT_BYTES - (2 * _MAX_COMMANDS * _MAX_STREAM_BYTES) < 131_072:
